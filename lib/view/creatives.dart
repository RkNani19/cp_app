...
class CreativeCard extends StatelessWidget {
                    ...
                    children: [
                      ...
                      Expanded(
                        child: GestureDetector(
                          onTap: () {
                            downloadFile(data.imageUrl, context);
                          },
                          child: Container(
                            height: 44,
                            decoration: BoxDecoration(
                      ...
                      Expanded(
                        child: GestureDetector(
                          onTap: () {
                            shareFile(data.imageUrl, data.type);
                          },
                          child: Container(
                            height: 44,
                            decoration: BoxDecoration(
  ...
  Future<void> downloadFile(String url, BuildContext context) async {
    try {
      ...
      /// 🔥 PUBLIC DOWNLOAD PATH (IMPORTANT)
      ...
      /// 🔥 Refresh gallery (IMPORTANT)
      await File(filePath).create();

      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text("Saved in Download folder")));
  ...
  Future<void> shareFile(String url, String type) async {
    try {
      final dio = Dio();
